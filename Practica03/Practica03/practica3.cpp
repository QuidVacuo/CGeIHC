...
// Pirámide triangular regular  *MODIFICADO PARA PRACTICA
...
int main()
{
	...
	CrearCilindro(40, 1.5f);//índice 2 en MeshList
	CrearCono(60, 2.0f);//índice 3 en MeshList
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		/*//ejercicio de clase : Instanciar primitivas geométricas para recrear el dibujo de la práctica pasada en 3D,
