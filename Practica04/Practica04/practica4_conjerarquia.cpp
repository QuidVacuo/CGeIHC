...
int main()
{
	...
	CrearCono(40, 0.5f);//índice 3 en MeshList
	...
	*/
	camera = Camera(glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f), -60.0f, 0.0f, 0.4f, 1.0f);
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Llanta 1 delantera izquierda (se mueve con K)
		...
		//Llanta 2 delantera derecha(Se mueve con L)
		...
		//Llanta 3 trasera izquierda (Se mueve con I)
		...
		//Llanta 4 trasera derecha(se mueve con O)
		model = glm::translate(model, glm::vec3(6.0f, 0.0f, 0.0f));
		modelaux2 = model;
		model = glm::scale(model, glm::vec3(1.2f, 1.2f, 1.2f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		//Canasta
		model = glm::translate(model, glm::vec3(2.4f, -1.5f, 0.0f));
		...
		///////////////////////////Animal robotico araña//////////////////////////
		//Visor
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 3.8f, 0.7f));
		...
		////////////////////Pata 1/////////////////////////////
		//Articulacion 1
		model = glm::translate(model, glm::vec3(-1.2f, -2.2f, 0.9));
		...
		sp.render();
		model = modelaux;
		//Pata 1 parte superior
		model = glm::translate(model, glm::vec3(-1.20f, 1.20f, 0.0f));
		model = glm::rotate(model, glm::radians(-45.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(3.0f, 0.3f, 0.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.6f, 0.6f, 0.6f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); 
		...
		//////////Pata 2///////////
		//Articulacion que une la pata con el cuerpo 
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(2.6f, -1.0f, 0.6f));
		...
		sp.render();
		model = modelaux;
		//Pata 2 parte superior
		model = glm::translate(model, glm::vec3(2.4f, 2.4f, 0.0f));
		model = glm::rotate(model, glm::radians(45.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(6.1f, 0.5f, 0.6f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.6f, 0.6f, 0.6f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		...
		//Articulacion que une la pata con el cuerpo 
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-2.5f, -1.0f, -2.75f));
		...
		//Articulacion que une la pata con el cuerpo 
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(2.6f, -1.0f, -2.75f));
		...
		///////////Orejas////////////
		//Articulacion derecha
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(2.2f, 4.0f, -1.0));
		...
		//Articulacion izquierda
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-2.2f, 4.0f, -1.0));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion17()), glm::vec3(1.0f, 0.0f, 0.0f));
		//model = glm::rotate(model, glm::radians(45.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.2f));
		color = glm::vec3(0.3f, 0.3f, 0.3f);
